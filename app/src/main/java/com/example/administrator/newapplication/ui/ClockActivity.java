...
import com.example.administrator.newapplication.fragment.SelectRemindCyclePopup;
import com.example.administrator.newapplication.fragment.SelectRemindWayPopup;
import com.example.administrator.newapplication.utils.StaticClass;
import com.example.mylibrary.AlarmManagerUtil;
            ...
            if (cycle == 0) {//是每天的闹钟
                ...
                for (int i = 0; i < weeks.length; i++) {
                    AlarmManagerUtil.setAlarm(this, 2, Integer.parseInt(times[0]), Integer
                            .parseInt(times[1]), i, Integer.parseInt(weeks[i]), "闹钟响了，该睡觉了", ring);
                }
            }
            Toast.makeText(this, "睡眠时间设置成功", Toast.LENGTH_LONG).show();
        }
